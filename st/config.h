 ...
 */
static char font[] = "Source Code Pro for Powerline:pixelsize=14:antialias=true";
...
static const char *colorname[] = {
	"#282828", /* dark black */ /* hard contrast: #1d2021 / soft contrast: #32302f */
	"#cc241d", /* dark red */
	"#98971a", /* dark green */
	"#d79921", /* dark yellow */
	"#458588", /* dark blue */
